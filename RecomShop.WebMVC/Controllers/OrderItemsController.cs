...
namespace RecomShop.WebMVC.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(RecomShopContext context)
        {
            _context = context;
        }
        ...
        {
            var recomShopContext = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
            return View(await recomShopContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,OrderId,ProductId,Quantity")] OrderItem orderItem)
        {
